...
import os
from inventory_creation.whatsappopration import send_message, recive_message
...
def extract_value(client,  conversation, response_format_class, prompt):
    """
    Extracts the price from a chat conversation using the specified model and response format.
    ...
    Returns:
        response_format_class: The structured result parsed by the provided class.
    """
