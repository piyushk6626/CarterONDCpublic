...
inputDatahandicraft = ['name', 'dob', 'pancard', 'gst_number', 'address', 'business_name', 'trade_license', 'udyam', 'account_number', 'ifsc_code', 'upi_id',  'noc', 'phoneNumber']

def store_data_handicraft(kwargs):
    ...
    c.execute("INSERT INTO handicraft (name, dob, pancard, gst_number, address, business_name, trade_license, udyam, account_number, ifsc_code, upi_id, noc, phoneNumber) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", (name, dob, pancard, gst_number, address, business_name, trade_license, udyam, account_number, ifsc_code, upi_id, noc, phoneNumber))
    conn.commit()
    conn.close()

def send_message_handicraft(data_type):
    msg = ""
